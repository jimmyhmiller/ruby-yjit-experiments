...
use crate::{
    ...
    cruby::{
        ...
        RUBY_SIZEOF_CONTROL_FRAME, RUBY_SPECIAL_SHIFT, RUBY_SYMBOL_FLAG, RUBY_T_ARRAY,
        RUBY_T_CLASS, RUBY_T_HASH, RUBY_T_ICLASS, RUBY_T_MASK, RUBY_T_MODULE, RUBY_T_OBJECT,
        RUBY_T_STRING, RUBY_T_STRUCT, SHAPE_ID_NUM_BITS, SIZEOF_VALUE, SIZEOF_VALUE_I32,
        ...
        VM_ENV_FLAG_WB_REQUIRED, VM_FRAME_FLAG_BMETHOD, VM_FRAME_FLAG_CFRAME,
        VM_FRAME_FLAG_CFRAME_KW, VM_FRAME_FLAG_LAMBDA, VM_FRAME_FLAG_MODIFIED_BLOCK_PARAM,
        VM_FRAME_MAGIC_BLOCK, VM_FRAME_MAGIC_CFUNC, VM_FRAME_MAGIC_METHOD, VM_METHOD_TYPE_ALIAS,
        VM_METHOD_TYPE_ATTRSET, VM_METHOD_TYPE_BMETHOD, VM_METHOD_TYPE_CFUNC, VM_METHOD_TYPE_ISEQ,
        VM_METHOD_TYPE_IVAR, VM_METHOD_TYPE_MISSING, VM_METHOD_TYPE_NOTIMPLEMENTED,
...
pub fn gen_single_block(
    ...
    let mut code_generator = CodeGenerator::new(jit, ctx, asm, CodegenGlobals::take_outlined_cb().unwrap());
    ...
    while insn_idx < iseq_size {
        ...
        if code_generator.jit.record_boundary_patch_point {
            ...
            let exit_pos = gen_outlined_exit(code_generator.jit.pc, &code_generator.ctx, &mut code_generator.ocb);
